...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--defense_model", type=str, default="model.UserModel.FP_resnet"
    )

    parser.add_argument("--model", type=str, default="model.UserModel.ResNet2")
    parser.add_argument(
        "--model_dir", type=str, default="../model/weights/resnet20_cifar.pt"
    )
    parser.add_argument(
        "--model_defence_dir", type=str, default="../model/weights/FP_ResNet20.th"
    )
